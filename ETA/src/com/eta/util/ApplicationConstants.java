...
public interface ApplicationConstants {
   static final String SHARED_PREFERENCE_FILE = "eta.shared.preferences";
   static final String PROPERTY_GCM_REG_ID = "gcm.registration.id";
   static final String PROPERTY_APP_VERSION = "app.version";
   static final String PROPERTY_IS_SIGNED_IN = "signed.in";
   static final String PROPERTY_USER_NAME = "user.name";
   static final String PROPERTY_USER_PHONE = "user.phone";
